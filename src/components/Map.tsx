  ...
  return (
    <section>
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center gap-5 p-5 py-4 w-full bg-blue-600 bg-opacity-10 rounded-xl">
          <img src="icons/info_circle.svg" className="h-6 w-auto text-blue-600" alt="Info" />
